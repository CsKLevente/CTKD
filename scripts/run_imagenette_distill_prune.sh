...
#python3 train_student.py --path-t ./save/models/baseline/imagenette/resnet34/ResNet34/ResNet34_best.pth \
#        --distill kd \
...
python3 train_student.py --path-t ./save/models/baseline/imagenette/resnet34/ResNet34/ResNet34_best.pth \
        --distill kd \
        --batch_size 64 --epochs 0 --dataset imagenette \
        --learning_rate 0.1 --lr_decay_epochs 30,60,90 --weight_decay 1e-4 \
        --model_s ResNet18 -r 1 -a 1 -b 0 --kd_T 4 \
        --have_mlp 0 --mlp_name 'global' \
        --save_model --print-freq 60 --sparsity_learning \
        --experiments_dir 'imagenette-tea-res34-stu-res18/KD/sparsity_learning/kd_T_4' \
        --experiments_name 'prune-1' \
        --path-s save/student_model/imagenette-tea-res34-stu-res18/KD/sparsity_learning/kd_T_4/fold-1/ResNet18_best_model.pth
#
#python3 train_student.py --path-t ./save/models/baseline/imagenette/resnet34/ResNet34/ResNet34_best.pth \
#        --distill kd \
#        --batch_size 64 --epochs 120 --dataset imagenette \
...
#        --decay_max 0 --decay_min -1 --decay_loops 5 \
#        --save_model --print-freq 60 --sparsity_learning \
#        --experiments_dir 'imagenette-tea-res34-stu-res18/KD/ctkd_120/sparsity_learning/kd_T_1.5' \
#        --experiments_name 'fold-1'
#
#python3 train_student.py --path-t ./save/models/baseline/imagenette/resnet34/ResNet34/ResNet34_best.pth \
#        --distill kd \
...
#        --decay_max 0 --decay_min -1 --decay_loops 5 \
#        --save_model --print-freq 60 --sparsity_learning \
#        --experiments_dir 'imagenette-tea-res34-stu-res18/KD/ctkd_120/sparsity_learning/kd_T_2' \
#        --experiments_name 'fold-1'
#
#python3 train_student.py --path-t ./save/models/baseline/imagenette/resnet34/ResNet34/ResNet34_best.pth \
#        --distill kd \
...
#        --decay_max 0 --decay_min -1 --decay_loops 5 \
#        --save_model --print-freq 60 --sparsity_learning \
#        --experiments_dir 'imagenette-tea-res34-stu-res18/KD/ctkd_120/sparsity_learning/kd_T_8' \
#        --experiments_name 'fold-1'
#
#python3 train_student.py --path-t ./save/models/baseline/imagenette/resnet34/ResNet34/ResNet34_best.pth \
#        --distill kd \
...
#        --decay_max 0 --decay_min -1 --decay_loops 5 \
#        --save_model --print-freq 60 --sparsity_learning \
#        --experiments_dir 'imagenette-tea-res34-stu-res18/KD/ctkd_120/sparsity_learning/kd_T_16' \
#        --experiments_name 'fold-1'